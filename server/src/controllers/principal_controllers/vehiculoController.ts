...
class VehiculoController{
    public async listarVehiculos(req:Request, res:Response):Promise<any>{
        try {
            const consulta = `
                                SELECT
    ...
    public async listarTotalVehiculosPorEmpresa(req:Request, res:Response):Promise<any>{
        try {
...
public async listarVehiculosDetallePorEmpresa(req:Request, res:Response):Promise<any>{
        try {
            const { id } = req.params;
            const consulta = `
                                    SELECT
    ...
    public async ObtenerVehiculo(req: Request, res: Response): Promise<void> {
        try {
            const { id } = req.params;
            const consulta= 'select * from t_vehiculo where id_vehiculo = $1';
            const vehiculo = await db.query(consulta,[id]);
    ...
    public async ModificarTucVehiculo(req: Request, res: Response): Promise<void> {
        try {
            const { id } = req.params;
    ...
    public async BajaVehiculo(req: Request, res: Response): Promise<void> {
        try {
            const { id } = req.params;
...
//=====================EN RELACION A LOS REPORTES=====================================================================================================================================
    ...
    public async listarVehiculosPorOrigenRuta(req:Request, res:Response):Promise<any>{
        try {
    ...
    public async listarVehiculosPorOrigenDestinoRuta(req:Request, res:Response):Promise<any>{
        try {
