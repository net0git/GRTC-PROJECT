...
class EmpresaServicioController{
    ...
    public async ObtenerEmpresaServicio(req:Request, res:Response):Promise<any>{
        try {
            ...
            const consulta = `
                    ...
                    `;
            const empresaServicios=await db.query(consulta,[id])
            res.json(empresaServicios['rows']);
        } catch (error) {
    ...
    public async ObtenerListaConductores(req:Request, res:Response):Promise<any>{
        try {
             const { id } = req.params;
            const consulta = `
            SELECT
                ...
                WHERE
                    ...
                    `;
            const conductores=await db.query(consulta,[id])
...
public async ObtenerEmpresaPorPlaca(req: Request, res: Response): Promise<void> {
    try {
...
public async ListarNombreResolucionesDeEmpresaServicio(req: Request, res: Response): Promise<void> {
    try {
        const { id } = req.params;
        const consulta = `
...
public async listarEmpresasPorRuta(req: Request, res: Response): Promise<void>{
    try {
        const consulta = `
                    SELECT DISTINCT
 ...
 public async listarEmpresasPorRutaOrigenDestino(req: Request, res: Response): Promise<void>{
    try {
