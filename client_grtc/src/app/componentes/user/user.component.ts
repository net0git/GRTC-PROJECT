...
objetosFiltrados:any=[];
  ...
  buscarEnObjeto(event: any) {
    ...
    this.objetosFiltrados = this.usuariodetalleAux.filter((objeto: 
      ...
      const nombres = objeto.nombres.toLowerCase();
      ...
      return tipo_doc.includes(textoBusqueda) || nombres.includes(textoBusqueda)|| ap_paterno.includes(textoBusqueda) ||ap_materno.includes(textoBusqueda) || nombre_usuario.includes(textoBusqueda)|| correo.includes(textoBusqueda)|| rol.includes(textoBusqueda)|| estado.includes(textoBusqueda);
    });
